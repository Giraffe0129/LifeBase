...
# installed.
TCL_PREFIX='E:/tool/Claude/my_first_vibecoding/env/vibe_coding_env01\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/tool/Claude/my_first_vibecoding/env/vibe_coding_env01\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/tool/Claude/my_first_vibecoding/env/vibe_coding_env01\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/tool/Claude/my_first_vibecoding/env/vibe_coding_env01\Library\include'
...
TCL_PACKAGE_PATH='E:/tool/Claude/my_first_vibecoding/env/vibe_coding_env01\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/tool/Claude/my_first_vibecoding/env/vibe_coding_env01\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/tool/Claude/my_first_vibecoding/env/vibe_coding_env01\Library\lib\tclstub86.lib'
